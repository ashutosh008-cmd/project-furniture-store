...
<section class="content">
      ...
      <div class="card-body p-0">
        <table class="table">
            ...
            <tr>
                ...
                <td><h5>
                    <form action="{{route('update.order.db',$order[0]->order_id)}}" method="POST">
                    @csrf
                    <select class="form-control" style="width: 20%;" name="order_status" id="order_status" aria-label="order_status">
                        ...
                        @if ($order[0]->order_status == 'dispatched')
                        selected    
                        @endif
                        >Dispatched</option>
    ...
    <div class="d-flex flex-row-reverse">
        ...
        <a class="btn btn-secondary btn-md mr-2 mb-4" type="submit" href="{{route('orders')}}">
            Cancle
        </a>
    </div>
    </form>
